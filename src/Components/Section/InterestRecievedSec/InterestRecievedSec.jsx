                ...
                <ul className="flex flex-col">
                  <li
                    className={`px-4 py-2 cursor-pointer hover:bg-gray-100 ${
                      filter === "received" ? "font-semibold text-[#FFB9C3]" : ""
                    }`}
                    onClick={() => {
                      setFilter("received");
                  ...
                  <li
                    className={`px-4 py-2 cursor-pointer hover:bg-gray-100 ${
                      filter === "sent" ? "font-semibold text-[#FFB9C3]" : ""
                    }`}
                    onClick={() => {
                      setFilter("sent");
                      setShowFilterOptions(false); 
          ...
          {bestmatches.map((match, index) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-4 flex justify-end px-9">
                <button className="bg-[#5e5e61] text-white font-bold p-5 rounded-full flex items-center text-xs md:text-sm lg:text-base hover:bg-[#FFB9C3] transition duration-200 transform hover:scale-110">
