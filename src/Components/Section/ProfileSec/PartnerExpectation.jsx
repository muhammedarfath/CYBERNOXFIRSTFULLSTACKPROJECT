  ...
  const sections = [
    {
      ...
      preferences: [
        { label: "Partner Age Preference", value: "Add Age Preferences", isAction: true },
        { label: "Partner Height Preference", value: "Add Height Preferences", isAction: true },
        { label: "Partner Marital Status Preference", value: "Does not matter" },
        { label: "Partner Physical Status Preference", value: "Does not matter" },
    ...
    },
    {
      ...
      preferences: [
        { label: "Partner District Preferences", value: "Add Partner District Preferences", isAction: true },
        { label: "Partner Present Country Preferences", value: "Add Nationality", isAction: true },
      ]
    }
  ];
        ...
        >
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            ...
            <div className="w-8 h-8 rounded-full bg-green-600 flex items-center justify-center">
              <TbEdit className="text-white w-5 h-5" />
            </div>
          </div>
            ...
            {section.preferences.map((pref, index) => (
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <span className={`text-lg ${pref.isAction ? 'text-primary2' : 'text-gray-900'}`}>
                    {pref.value}
                  </span>
