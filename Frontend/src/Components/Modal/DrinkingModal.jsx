...
function DrinkingModal({ open, setOpen, setDrinkingPreference }) {
  ...
  useEffect(() => {
    if (open) {
      ...
      fetchDrinkingOptions();
    }
  }, [open]);

  const filteredOptions = drinkingOptions.filter((option) =>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-lg relative">
        ...
        {/* Header */}
        <div className="p-6">
          <h2 className="text-xl font-semibold">Select Drinking Preference</h2>
        </div>
        ...
        <div className="p-6">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search drinking preference"
              value={search}
